import { Upgraded as UpgradedEvent } from "../generated/aArbUSDT/aArbUSDT"
...
import { BalanceTransfer as BalanceTransferUSDT } from "../generated/aArbUSDT/aArbUSDT";
...
aTokenMapping.set('0x6ab707Aca953eDAeFBc4fD23bA73294241490620', '0xfd086bc7cd5c481dcc9c85ebe478a1c0b69fcbb9'); // aArbUSDT -> USDT

let decimalMapping = new Map<string, i32>();
decimalMapping.set('0xfd086bc7cd5c481dcc9c85ebe478a1c0b69fcbb9', 6);  // USDT

export function handleBalanceTransferUSDT(event: BalanceTransferUSDT): void {
  // let aTokenAddress = event.address.toHexString();
  let aTokenAddress = '0x6ab707Aca953eDAeFBc4fD23bA73294241490620';
