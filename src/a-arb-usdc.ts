import { Upgraded as UpgradedEvent } from "../generated/aArbUSDC/aArbUSDC"
...
import { BalanceTransfer as BalanceTransferUSDC } from "../generated/aArbUSDC/aArbUSDC";
...
aTokenMapping.set('0x625E7708f30cA75bfd92586e17077590C60eb4cD', '0xff970a61a04b1ca14834a43f5de4533ebddb5cc8'); // aArbUSDC -> USDC

let decimalMapping = new Map<string, i32>();
decimalMapping.set('0xff970a61a04b1ca14834a43f5de4533ebddb5cc8', 6);  // USDC

export function handleBalanceTransferUSDC(event: BalanceTransferUSDC): void {
  // let aTokenAddress = event.address.toHexString();
  let aTokenAddress = '0x625E7708f30cA75bfd92586e17077590C60eb4cD'
